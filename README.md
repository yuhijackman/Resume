...
5. 英語でのコミュニケーションが取れる(TOEIC 990点)
...
<details>
   ...
   <div>
	...
	<p>多くのページで似たようなデザインの部品が多く存在していたこと、クライアントや編集者の要望でデザインの変更や追加が頻繁に起きることを考慮し</p>
	<p>再利用性が高く、機能変更、デザイン変更に柔軟にかつ少ない工数で対応できるよう設計した。</p>
	...
	<p>それぞれのコンポーネントの責務が明確化し、影響範囲の把握が容易になった。</p>
    </div>
</details>
